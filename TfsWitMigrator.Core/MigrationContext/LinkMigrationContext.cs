...
namespace TfsWitMigrator.Core
{
    public class LinkMigrationContext : MigrationContextBase
    {
        ...
        internal override void InternalExecute()
        {
            ...
            tfsqc.Query = @"SELECT [System.Id] FROM WorkItems WHERE  [System.TeamProject] = @TeamProject AND [System.RelatedLinkCount] > 0 AND [TfsMigrationTool.ReflectedWorkItemId] = '' AND  [Microsoft.VSTS.Common.ClosedDate] = '' ORDER BY [System.ChangedDate] desc "; // AND  [Microsoft.VSTS.Common.ClosedDate] = ''
