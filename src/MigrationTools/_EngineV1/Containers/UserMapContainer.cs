...
{
    public class UserMapContainer : EngineContainer<ReadOnlyDictionary<string, string>>
    {
        ...
        public UserMapContainer(IServiceProvider services, IOptions<EngineConfiguration> config) : base(services, config)
        {
