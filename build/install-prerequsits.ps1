...
if (((npm list -g tfx-cli) -join "," ).Contains("empty")) {
    Write-InfoLog "Installing tfx-cli"
    npm i -g tfx-cli
} else { Write-InfoLog "Detected tfx-cli"}


Write-InfoLog "REFRESH ENVIRONMENT"
Write-InfoLog "------------"
# Refresh environment
